...
- (BOOL) updateWithOnConflictTableName: (NSString*)table withValues: (NSDictionary*)contentValues withWhereClause: (NSString*)whereClause withWhereArgs:   (NSArray *)whereArgs withConflict: (conflictType_e)eConflictAlgorithm
{
    BOOL bResult = NO;
